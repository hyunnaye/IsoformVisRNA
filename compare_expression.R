...
calculateRatios <- function(counts_dir, cm_path, metadata_path, transcript_id1, transcript_id2) {
  ...
  ratioDF$Disease_type <- metadata$Biosample_summary 
  return(ratioDF)
}

ratioDF <- calculateRatios("IsoformVisRNA/transcript_quants", "IsoformVisRNA/combinedCM.tsv", "IsoformVisRNA/cleaned_metadata.tsv", "ENST00000316724.9", "ENST00000409400.1")
